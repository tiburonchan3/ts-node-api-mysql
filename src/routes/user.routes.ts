...
userRouter.post('/register', userRules['forRegister'], (req: express.Request, res: express.Response) => {
...
userRouter.post('/login', userRules['forLogin'], (req: express.Request, res: express.Response) => {
    const errors = validationResult(req)
